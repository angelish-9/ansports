...
import { addProduct, listProduct, removeProduct, singleProduct, categoryProduct, rentableProducts } from '../controller/productController.js';
...
productRouter.get('/rentals', rentableProducts);
